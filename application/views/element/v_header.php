...
<script type="text/javascript">
		$(function () { 
					new PNotify({
						title: 'Hai QT',
						text: 'Kamu memiliki <?php echo $jumlah_project_aktif_qt;?> project aktif <br> <?php echo $jumlah_new_project_qt;?> project baru <br> dan <?php echo $jumlah_project_expired_qt;?> project expired',
