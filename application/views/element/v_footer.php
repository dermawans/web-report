		...
		<script src="<?php echo base_url('assets/vendor/flot/jquery.flot.resize.js')?>">
		...
		<script src="<?php echo base_url('assets/vendor/chartist/chartist.js')?>"></script></script>
		...
		<script src="<?php echo base_url('assets/vendor/bootstrap-confirmation/bootstrap-confirmation.js')?>"></script>
...
(function() {
	...
	*/
	Morris.Bar({
		...
		ykeys: 
		[
		<?php foreach($data_grafikstatus as $d){?>
		"<?php echo $d->status_project;?>",<?php } ?>],
		labels: [
		<?php foreach($data_grafikstatus as $a){?>
		"<?php echo $a->status_project;?>",<?php } ?>],
		hideHover: true
	});
	})();
</script>
